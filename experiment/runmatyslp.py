...
mlpp = price_models.MatysLPPriceModel(hidden_sizes=[32],
                 weight_decay = 1e-2,
                 embedding_dim=4, 
                 lr=1e-3, 
                 batch_size=64, 
...
save_dir = "data/processed/evaluation_matyslp.png"
...
score = eval_performance(df_y_test_inverted.values, df_final_preds.values)
print(f"Taux de capture batterie : {score:.3f}")
