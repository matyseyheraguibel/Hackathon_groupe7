import pandas as pd
import numpy as np
from source.price_models.lstm import LSTMPriceModel
...
lstm_model.fit(X_train, Y_train, eval_set=(X_test, Y_test))

df_final_preds     = get_pred_df_inverted(X_test, lstm_model.predict(X_test), csv_coef)
df_y_test_inverted = get_pred_df_inverted(X_test, Y_test.values, csv_coef)

save_dir = "data/processed/evaluation_lstm.png"
